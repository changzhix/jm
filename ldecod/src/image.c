...
int decode_one_frame(ImageParameters *img,struct inp_par *inp, struct snr_par *snr)
{
  ...
  while ((currSlice->next_header != EOS && currSlice->next_header != SOP))
  {
    ...
    if(HEADERCHECK=getenv("HEADERCHECK"))
        printf("@@CUR_FRAME_SLICE_NUM:%d\n",img->current_slice_nr);
  }
...
//        printf("swtich: NALU_TYPE_SLICE\n");
//	goto ll;
      case NALU_TYPE_IDR:
//        printf("swtich: NALU_TYPE_IDR\n");
//ll:
...
if (params->disable_postprocessing == FALSE) {
